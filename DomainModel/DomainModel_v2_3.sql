...
CREATE TABLE IF NOT EXISTS `ZXQ`.`stu_identity` (
  ...
  INDEX `fk_stu_identity_user1_idx` (`user_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`organization_has_user` (
  ...
  INDEX `fk_organization_has_user_user1_idx` (`user_user_id` ASC) VISIBLE,
  INDEX `fk_organization_has_user_organization_idx` (`organization_org_name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`founder` (
  ...
  INDEX `fk_founder_organization1_idx` (`organization_org_name` ASC, `organization_founder_name` ASC) VISIBLE,
  INDEX `fk_founder_user1_idx` (`user_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`com_identity` (
  ...
  INDEX `fk_job_identity_user1_idx` (`user_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`task` (
  ...
  `wjx_id` VARCHAR(20) NULL DEFAULT NULL,
  ...
  INDEX `fk_task_audit_administrator1_idx` (`audit_administrator_audit_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`publisher` (
  ...
  INDEX `fk_publisher_user1_idx` (`user_user_id` ASC) VISIBLE,
  INDEX `fk_publisher_task1_idx` (`task_task_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`user_has_task` (
  ...
  INDEX `fk_user_has_task_task1_idx` (`task_task_id` ASC, `task_audit_administrator_audit_id` ASC) VISIBLE,
  INDEX `fk_user_has_task_user1_idx` (`user_user_id` ASC) VISIBLE,
