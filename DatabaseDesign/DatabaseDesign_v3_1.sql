...
CREATE TABLE IF NOT EXISTS `ZXQ`.`com_identity` (
  `user_com_id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(5) NOT NULL,
  `email` VARCHAR(30) NOT NULL,
  `phone_number` VARCHAR(11) NOT NULL,
  `gender` VARCHAR(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ZXQ`.`task` (
  ...
  `participants_num` INT NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `ZXQ`.`user_task_job`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZXQ`.`user_task_job` (
  `task_task_id` INT NOT NULL,
  `user_user_id` INT NOT NULL,
  ...
  INDEX `fk_user_task_job_task1_idx` (`task_task_id` ASC) ,
  INDEX `fk_user_task_job_user1_idx` (`user_user_id` ASC) ,
  CONSTRAINT `fk_user_task_job_task1`
    FOREIGN KEY (`task_task_id`)
    REFERENCES `ZXQ`.`task` (`task_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_task_job_user1`
    FOREIGN KEY (`user_user_id`)
    REFERENCES `ZXQ`.`user` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
